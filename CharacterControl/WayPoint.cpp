...
int Event_CREATE_WAYPOINT::l_Construct(lua_State* luaVM)
{
	...
	//nextNextWayPointName
	//const char* nextNextWayPointName = lua_tostring(luaVM, -numArgs--);
	...
	//nextNextWayPointName
	//StringOps::writeToString(nextNextWayPointName, pEvt->m_nextNextWaypointName, 32);  
...
: Component(context, arena, hMyself)
{
	...
	//nextNextWaypointName
	//StringOps::writeToString(pEvt->m_nextNextWaypointName, m_nextNextWayPointName, 32);
	m_base = pEvt->m_base;
}
