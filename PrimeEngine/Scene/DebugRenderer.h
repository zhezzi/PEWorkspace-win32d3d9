...
struct DebugRenderer : public SceneNode
{
	...
	// Add draw mesh bounding volume func and draw edge func
	void drawMeshBoundingVolume(Vector3 minPoint, Vector3 maxPoint, Matrix4x4 base, Vector3 color, float timeToLive);
	void drawBoundingBoxEdge(Vector3 startPoint, Vector3 endPoint, Vector3 color, Matrix4x4 base);
